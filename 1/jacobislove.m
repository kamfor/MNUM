...
fprintf('Rozwiazanie ukladu z zadaina:\n');
fprintf('%g\n',x);
fprintf('Blad dla ukladu z zadaina: %g,\n',error); 
...
for i= 1:3 % iteracja po podpunktach z zadania 2
  ...
  fprintf('Zastosowanie metody do ukladow z zadania 2,'); 
  fprintf('Podpunkt: %d ,Liczba rownan: %d , Blad: %g , Czas: %d sek. \n',i,result(1,j+1),result(2,j+1),time);
